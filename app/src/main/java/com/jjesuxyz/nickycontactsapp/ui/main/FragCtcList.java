...
/**
 * This fragment is used to create a ListView to show all the contacts that are in the database
 * Contacts table.
 * This class contains an interface to communicate with the MainActivity class. So that class
 ...
 */
public class FragCtcList extends ListFragment implements AdapterView.OnItemClickListener {

    private OnFragmentInteractionListener mListener;

    private ArrayList<String> arrayListName;
    private ArrayList<String> arrayListPhone;
    private static String fragmentInfo;
     ...
     *
     * @return A new instance of fragment FragCtcList.
     */
    // TODO: Rename and change types and number of parameters
    public static FragCtcList newInstance(String fragName) {
        fragmentInfo = fragName;
        FragCtcList fragment = new FragCtcList();
        return fragment;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
                             // Creating ArrayList to hold names and phone numbers
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.frag_ctc_list, container, false);
    }
     ...
     * of all contacts from the Contacts table. The cursor returned from the database query is pass
     * to the ArrayAdapter used to create the ListView used in this fragment.
     *
     * @param savedInstanceState Bundle
     */
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        DbSQLHelper dbSQLHelper = new DbSQLHelper(getContext());
        Cursor cursorListaCtcs = dbSQLHelper.getAllContactsData();
                             // Creating the ArrayAdapter to create the ListView
        MyArrayAdapter myArrayAdapter = new MyArrayAdapter(getActivity(), cursorListaCtcs);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFragmentInteraction(0, "0", "Name", "Phone");
        }
    }
...
}   // End of FragCtcList class


/************************************END OF FILE FragCtcList.java**********************************/
